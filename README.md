...
<br/>
[Youtube](https://youtube.com/c/aidanqm)

## Usage
1. Download the specific scripting utility of your choice.
2. Execute the provided loadstring below.
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/aidanqm/VapeV4ForRoblox/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/aidanqm/VapeV4ForRoblox/refs/heads/main/NewMainScript.lua)
3. Ensuring no external script is conflicting with vape.

## Developers & Credits
[aidanqm](https://github.com/aidanqm) - Lead maintainer of the project - vaperoblox on Discord
<br/>
